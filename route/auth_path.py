...
SECRET_KEY = setting.config_env.secret_key
ALGORITHM = setting.config_env.algorithm
ACCESS_TOKEN_EXPIRE_MINUTES = int(setting.config_env.access_token_valid_time)
